...
export function AiAnalyst() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        { role: 'ai', content: 'Hello! I am your AI Data Analyst. Select a datasource and ask me anything about your data.' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            setMessages(prev => [...prev, { role: 'ai', content: `Error: ${error.message || 'Something went wrong. Please try again.'}` }]);
        } finally {
            setLoading(false);
        }
    };
