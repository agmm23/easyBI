...
export function DashboardChart({ chart, startDate, endDate }: DashboardChartProps) {
    const [data, setData] = useState<any>(null);
    const [loading, setLoading] = useState(true);

    useEffect(() => {
        let url = `http://localhost:8000/api/datasources/${chart.datasource_id}/data?sort_by=${chart.x_column}`;
    ...
    }, [chart.datasource_id, chart.date_column, startDate, endDate]);
